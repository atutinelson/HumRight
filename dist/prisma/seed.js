import { PrismaClient, MatchStatus, PaymentStatus, TipOutcome, } from "@prisma/client";
...
async function main() {
    ...
    */
    ...
    =====================================================
    */
    await Promise.all(payments.map((payment, index) => prisma.tipAccessLog.create({
        data: {
    ...
    =====================================================
    */
    await Promise.all(predictions.map((prediction, index) => prisma.tipResult.create({
        data: {
